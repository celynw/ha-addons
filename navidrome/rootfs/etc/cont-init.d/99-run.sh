...
export ND_JUKEBOX_DEFAULT=$(bashio::config "Jukebox.Default") && bashio::log.info "ND_JUKEBOX_DEFAULT set to $ND_JUKEBOX_DEFAULT"
export ND_JUKEBOX_DEVICES=$(bashio::config "Jukebox.Devices") && bashio::log.info "ND_JUKEBOX_DEVICES set to $ND_JUKEBOX_DEVICES"
export ND_JUKEBOX_ENABLED=$(bashio::config "Jukebox.Enabled") && bashio::log.info "ND_JUKEBOX_ENABLED set to $ND_JUKEBOX_ENABLED"
export ND_LASTFM_APIKEY=$(bashio::config "LastFM.ApiKey") && bashio::log.info "ND_LASTFM_APIKEY set to $ND_LASTFM_APIKEY"
export ND_LASTFM_ENABLED=$(bashio::config "LastFM.Enabled") && bashio::log.info "ND_LASTFM_ENABLED set to $ND_LASTFM_ENABLED"
export ND_LASTFM_SECRET=$(bashio::config "LastFM.Secret") && bashio::log.info "ND_LASTFM_SECRET set to $ND_LASTFM_SECRET"
export ND_LISTENBRAINZ_ENABLED=$(bashio::config "ListenBrainz.Enabled") && bashio::log.info "ND_LISTENBRAINZ_ENABLED set to $ND_LISTENBRAINZ_ENABLED"
...
export ND_SPOTIFY_ID=$(bashio::config "Spotify.ID") && bashio::log.info "ND_SPOTIFY_ID set to $ND_SPOTIFY_ID"
export ND_SPOTIFY_SECRET=$(bashio::config "Spotify.Secret") && bashio::log.info "ND_SPOTIFY_SECRET set to $ND_SPOTIFY_SECRET"
